...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { dob: @reminder.dob, email: @reminder.email, message: @reminder.message, name: @reminder.name } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { dob: @reminder.dob, email: @reminder.email, message: @reminder.message, name: @reminder.name } }
